    ...
    public class AnimalShelterDbContext : DbContext
    {
        ...
        public static void SeedDbContext(IServiceProvider serviceProvider)
        {
            ...
            if (context.Database.EnsureCreated())
            {
                ...
                // Animales
                var dog1 = new Animal(AnimalTypeEnum.Dog, "Naye", "Naye es una hembra de 2 años, mezcla de galso. Extremadamente cariñosa y amable con los niños.", 2, "1.jpg");
                var dog2 = new Animal(AnimalTypeEnum.Dog, "Zeta", "El perro de más bondad que tenemos. Macho de 2 años, ideal para tener en una casa con espacio.", 2 , "2.jpg");
                var dog3 = new Animal(AnimalTypeEnum.Dog, "Cuna", "Precioso macho de pastor alemán. Un perro con 6 años ideal para salir a hacer deporte con el.", 6, "adopcion1.jpg");
                var dog4 = new Animal(AnimalTypeEnum.Dog, "Kirian", "Hembra super juguetona de 2 años. Super cariñosa sobre todo con los más pequeños de la familia.", 2, "adopcion2.jpg");
                ...
                var cat2 = new Animal(AnimalTypeEnum.Cat, "Disha", "Esta preciosa gatita de 3 meses nos la encontramos en un parque y no paró de seguirnos hasta venirse con nosotros.", 3, "gato4.jpg");
